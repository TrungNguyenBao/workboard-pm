...
import { CalendarDays, CheckSquare, Link2, MessageSquare, Paperclip, Tag, User, X } from 'lucide-react'
...
import { cn, formatDate, formatRelativeTime, generateInitials } from '@/shared/lib/utils'
