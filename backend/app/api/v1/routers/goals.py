...
from app.schemas.goal import GoalCreate, GoalResponse, GoalUpdate, LinkProjectRequest, LinkTaskRequest
...
async def list_linked_projects(
    ...
    from app.models.goal import GoalProjectLink
...
async def list_linked_tasks(
    ...
    from app.models.goal import GoalTaskLink
    from sqlalchemy import select as sa_select
    from sqlalchemy.orm import selectinload
    links = await db.scalars(
